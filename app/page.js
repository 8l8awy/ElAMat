...
// 1. الاستيرادات يجب أن تكون هنا في الأعلى فقط
import { useState } from 'react';
import { useRouter } from 'next/navigation';
import { useAuth } from '@/context/AuthContext';
import { db } from '@/lib/firebase'; // استيراد قاعدة البيانات هنا
import { collection, query, where, getDocs, addDoc } from 'firebase/firestore'; // استيراد دوال فايربيس هنا
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // لاحظي: نستخدم db مباشرة لأننا استوردناه في الأعلى
