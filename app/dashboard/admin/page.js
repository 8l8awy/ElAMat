...
export default function AdminDashboard() {
  ...
  // ✅ التصحيح هنا: استخدامنا selectedFile
  ...
  return (
    <div className="min-h-screen bg-[#0b0c15] text-white p-6 lg:p-10 font-sans" dir="rtl">
        ...
        {filteredMaterials.map((item) => (
          <div key={item.id} className="bg-[#151720] border border-gray-800 rounded-2xl p-5 hover:border-blue-500/30 transition-all group relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-gray-800">
                {/* ✅ هنا نستخدم setSelectedFile بشكل صحيح */}
                <button 
      ...
      {/* ✅ Modal - استخدام selectedFile بشكل صحيح */}
      {selectedFile && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-[#151720] w-full max-w-4xl h-[85vh] rounded-2xl border border-gray-700 flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="flex-1 bg-gray-950 relative flex items-center justify-center p-4 overflow-auto">
