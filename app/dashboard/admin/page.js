...
const subjectsBank = {
    ...
    year3: { 
      ...
      2: [
        // مواد مشتركة وشعبة إدارة المشروعات الصناعية
        ...
        // مواد شعبة إدارة البنوك والأسواق المالية
        "إدارة مالية متقدمة", "المحاسبة المتوسطة (2)"
      ] 
    },
    year4: { 
      ...
      2: [
        // مواد مشتركة وشعبة إدارة المشروعات الصناعية
        "إدارة المحافظ المالية والمشتقات", "مشروع التخرج", "إدارة الموارد البشرية", "الأعمال الإلكترونية", "الإحصاء التطبيقي", "قواعد البيانات"
      ] 
    }
  };
