...
// ✅ 1. تصحيح الأيقونات لتنجح عملية الـ Build في Vercel
import { 
  FaCloudDownloadAlt, // بدلاً من FaCloudArrowDown
  FaEye, 
  FaFolderOpen, 
  FaFilePdf, 
  FaFileImage,
  FaShareAlt,         // بدلاً من FaShareNodes
  FaTimes,
  FaExternalLinkAlt     
} from "react-icons/fa"; 
...
function MaterialsContent() {
  ...
  return (
    <div>
      ...
      {/* ✅ 2. هنا التغيير الجذري: استخدام <object> بدلاً من Google Viewer لإصلاح مشكلة العرض */}
      {previewFile && (
